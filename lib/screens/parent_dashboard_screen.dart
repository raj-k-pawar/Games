...
class _SettingsTabState extends State<_SettingsTab> {
  ...
  Widget build(BuildContext context) => SingleChildScrollView(padding: const EdgeInsets.symmetric(horizontal: 20), child: Column(
    ...
    const SizedBox(height: 10),
    Row(children: <Widget>[
      for (final a in ['5-7','8-12','13-15']) Expanded(child: GestureDetector(onTap: () => setState(()=>_age=a),
        child: AnimatedContainer(duration: const Duration(milliseconds: 200),
          ...
          child: Center(child: Text(a, style: TextStyle(color: a==_age?Colors.white:AppColors.textG, fontWeight: FontWeight.w800, fontSize: 14)))))),
    ]),
    const SizedBox(height: 18),
    const Text('Difficulty', style: TextStyle(color: Colors.white, fontSize: 15, fontWeight: FontWeight.w800)),
    const SizedBox(height: 10),
    Row(children: <Widget>[
      for (final d in ['auto','easy','medium','hard']) Expanded(child: GestureDetector(onTap: () => setState(()=>_difficulty=d),
        child: AnimatedContainer(duration: const Duration(milliseconds: 200),
          ...
          child: Center(child: Text(d[0].toUpperCase()+d.substring(1), style: TextStyle(color: d==_difficulty?Colors.white:AppColors.textG, fontWeight: FontWeight.w800, fontSize: 11)))))),
    ]),
    const SizedBox(height: 18),
