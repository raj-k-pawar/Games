...
class _DifficultyInfo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final info = {
      'easy': {'emoji': '😊', 'text': '10 questions • 20-30 sec each • 10 pts/correct', 'color': AppColors.primaryGreen},
      'medium': {'emoji': '🤔', 'text': '10 questions • 25-35 sec each • 20 pts/correct', 'color': AppColors.primaryOrange},
      'hard': {'emoji': '😤', 'text': '10 questions • 20-25 sec each • 30 pts/correct', 'color': AppColors.primaryPink},
    };
