# 🎓 KidzoLand — Gamified Educational App
...
git init
git add .
git commit -m "KidzoLand initial commit"
git branch -M main
git remote add origin https://github.com/YOUR_USERNAME/kidzoland.git
...
3. Select **GitHub** → Authorize → Pick your `kidzoland` repo
...
│   │   ├── src/main/
│   │   │   ├── AndroidManifest.xml
│   │   │   ├── kotlin/com/kidzoland/app/MainActivity.kt
│   │   │   └── res/
...
```bash
# macOS / Linux:
base64 -i kidzoland.keystore | pbcopy

# Windows PowerShell:
[Convert]::ToBase64String([IO.File]::ReadAllBytes("kidzoland.keystore")) | clip
```
